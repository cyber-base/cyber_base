 ...
 */
final class Version20220422112823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animateur (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_2064DB2CE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE atelier (id INT AUTO_INCREMENT NOT NULL, animateurs_id INT NOT NULL, libelle VARCHAR(50) NOT NULL, date DATE NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME NOT NULL, statut VARCHAR(50) NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_E1BB182390098870 (animateurs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usager (id INT NOT NULL, quartiers_id INT NOT NULL, partenaires_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, categorie VARCHAR(50) NOT NULL, niveau VARCHAR(50) NOT NULL, loisir VARCHAR(50) NOT NULL, adresse VARCHAR(100) NOT NULL, ville VARCHAR(50) NOT NULL, cp VARCHAR(10) NOT NULL, UNIQUE INDEX UNIQ_3CDC65FFE7927C74 (email), INDEX IDX_3CDC65FFA6AAD912 (quartiers_id), INDEX IDX_3CDC65FF38898CF5 (partenaires_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE atelier ADD CONSTRAINT FK_E1BB182390098870 FOREIGN KEY (animateurs_id) REFERENCES animateur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE atelier DROP FOREIGN KEY FK_E1BB182390098870');
